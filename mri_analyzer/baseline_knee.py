BASELINE_KNEE = {
    "T1_KNEE": {
        ...
        "params": {
            ...
            "FOV (mm)":             {"min": 140,  "max": 180,   "optimal": 160,  "unit": "mm",    "impact": "커버리지"},
        }
    },
    "T2_KNEE": {
        "label": "🦵 Knee - T2 (연골/인대)",
    ...
    "PD_KNEE": {
        ...
        "params": {
            ...
            "Slice Thickness (mm)": {"min": 2,    "max": 3,     "optimal": 2.5,  "unit": "mm",    "impact": "해상도"},
            "NEX/NSA":              {"min": 2,    "max": 4,     "optimal": 2,    "unit": "",      "impact": "SNR"},
    ...
    "GRE_KNEE": {
        "label": "🦵 Knee - GRE (연골 정밀)",
        "params": {
            "TR (ms)":              {"min": 400,  "max": 700,   "optimal": 550,  "unit": "ms",    "impact": "T2* 대조도"},
            "TE (ms)":              {"min": 10,   "max": 20,    "optimal": 15,   "unit": "ms",    "impact": "T2* 대조도"},
            "Flip Angle (°)":       {"min": 10,   "max": 20,    "optimal": 15,   "unit": "deg",   "impact": "연골 대조도"},
            "Slice Thickness (mm)": {"min": 1.5,  "max": 3,     "optimal": 2,    "unit": "mm",    "impact": "해상도"},
            "NEX/NSA":              {"min": 1,    "max": 3,     "optimal": 2,    "unit": "",      "impact": "SNR"},
            "Matrix Row":           {"min": 256,  "max": 512,   "optimal": 384,  "unit": "",      "impact": "해상도"},
            "FOV (mm)":             {"min": 140,  "max": 180,   "optimal": 160,  "unit": "mm",    "impact": "커버리지"},
        }
    },
